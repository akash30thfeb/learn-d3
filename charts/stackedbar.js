function draw_stackedbar(csvpath, svg_el, xcol_name, yaxis_label){
  ...
  d3.csv(csvpath, type, function(error, data) {
    ...
    x.domain(data.map(function(d) { return d[xcol_name]; }));
    ...
    g.selectAll(".serie")
      ...
      .enter().append("rect")
        .attr("x", function(d) { return x(d.data[xcol_name]); })
